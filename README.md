...
| **WMA** | FIR | Medium | Medium | Medium | Low | Medium |
| **EMA** | IIR | Medium | Medium | Medium | Low | Low |
| **DEMA** | IIR | Low | Medium | High | Medium | Medium |
| **TEMA** | IIR | Very Low | Medium | Very High | High | Medium |
| **HMA** | FIR | Low | Medium | High | Medium | High |
| **HEMA** | IIR | Low-Medium | High | High | Low | High |
| **ZLEMA** | IIR | Very Low | Low | Very High | Medium | Medium |
| **ZLDEMA** | IIR | Very Low | Low | Very High | Medium-High | Medium |
| **ZLTEMA** | IIR | Extremely Low | Low | Extremely High | Medium-High | High |
| **DWMA** | FIR | Low | Medium | High | Low | Medium |
| **JMA** | IIR | Extremely Low | Extremely High | High | Extremely Low | Very High |
| **RMA** | IIR | High | High | Low | Very Low | Low |
| **TRIMA** | FIR | High | Very High | Low | None | Medium |
| **EPMA** | FIR | Medium | Low | Medium | Low | Medium |
