...
| `a` | `input.float` | default: `0.5`, label: "Alpha (taper fraction)" |
...
- Source code: `indicators/trends_FIR/tukey_w.pine`
- Documentation file: `indicators/trends_FIR/tukey_w.md`
- GitHub source view: https://github.com/mihakralj/QuanTAlib/blob/main/indicators/trends_FIR/tukey_w.pine
