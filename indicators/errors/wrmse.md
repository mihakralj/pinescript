...
- `Calculates Weighted Root Mean Squared Error`
- `Calculates WRMSE with uniform weights (equivalent to RMSE)`
...
| `weight` | Series of weights for each observation |
...
| `i_use_volume_weights` | `input.bool` | default: `false`, label: "Use Volume as Weights" |
...
- Source code: `indicators/errors/wrmse.pine`
- Documentation file: `indicators/errors/wrmse.md`
- GitHub source view: https://github.com/mihakralj/QuanTAlib/blob/main/indicators/errors/wrmse.pine
